...
vim.keymap.set('n', '<leader>cp', function() vim.fn.setreg('+', vim.fn.fnamemodify(vim.fn.expand '%:p', ':~:.')) end, { desc = '[C]opy relative [P]ath' })
vim.keymap.set('n', '<leader>cP', function() vim.fn.setreg('+', vim.fn.expand '%:p') end, { desc = '[C]opy absolute [P]ath' })
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set(
        ...
        { desc = '[S]earch by [G]rep ALL (hidden+ignored)' }
      )
